...
class player:
	...
	def can_move_up(self, labyrinth_map):
		if labyrinth_map.map_with_player[self.player_position[0] - 1][self.player_position[1]] == " ":
			return True
		else:
			return False
	...
	def can_move_right(self, labyrinth_map):
		if labyrinth_map.map_with_player[self.player_position[0]][self.player_position[1] + 1] == " ":
			return True
		else:
			return False
	...
	def move_up(self, labyrinth_map):
		if labyrinth_map.map_with_player[self.player_position[0] - 1][self.player_position[1]] == " ":
			labyrinth_map.map_with_player[self.player_position[0]][self.player_position[1]] = "L"
